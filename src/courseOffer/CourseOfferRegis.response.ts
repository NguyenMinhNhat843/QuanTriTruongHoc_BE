...
import { ResponseFindOneSubject } from "../subject/subject.response";
import { CourseOfferRegisResponseDto } from "./ourseOfferRegis.response"; // Giữ nguyên tên file import lỗi chính tả gốc của bạn
...
export class CourseOfferDetailResponseDto implements CourseOffer {
  ...
  @ValidateNested()
  @Type(() => ResponseFindOneSubject)
  subject: ResponseFindOneSubject | null;
  ...
  @ApiPropertyOptional({
    type: [GradeComponentDto], // Khai báo mảng Object cho Swagger
    nullable: true,
  ...
  gradeConfig: GradeComponentDto[] | null;
}
