import { Controller, Get, Body, Patch, Param, Delete, Query, ParseIntPipe, UseGuards } from "@nestjs/common";
...
export class AdmissionCampaignMajorController {
  constructor(private readonly admissionCampaignMajorService: AdmissionCampaignMajorService) {}
  ...
  @ApiResponse({ status: 200, type: AdmissionCampaignMajorDto })
  update(@Param("id", ParseIntPipe) id: number, @Body() dto: UpdateAdmissionCampaignMajorDto) {
